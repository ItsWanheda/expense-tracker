...
> 🚧 **Current development line: v0.5.0 — Financial Intelligence**. This branch extends the v0.4.x feature set with analytics, trends, comparisons, and dashboard intelligence while preserving the existing CLI, web, wallet, currency, budget, recurring-expense, and import/export workflows.
